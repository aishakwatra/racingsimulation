...
Car::Car()
    ...
    acceleration(11.0f),
    brakingForce(20.0f),
    frontLeftWheel(glm::vec3(-0.65f, -0.6f, 0.85f)),
    frontRightWheel(glm::vec3(0.65f, -0.6f, 0.85f)),
    backLeftWheel(glm::vec3(-0.65f, -0.6f, -0.85f)),
    backRightWheel(glm::vec3(0.65f, -0.6f, -0.85f)),
