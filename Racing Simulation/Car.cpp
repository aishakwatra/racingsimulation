...
void Car::setCollisionGrid(const std::vector<std::vector<std::vector<Triangle>>>& gridCells,const std::vector<std::vector<std::vector<Triangle>>>& gridCellsCollision, float gridSize, int gridWidth, int gridHeight) {
